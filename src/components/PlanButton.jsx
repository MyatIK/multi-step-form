...
function PlanButton({src,alt,text,planPrice,free}){
    ...
    return(
        ...
        <button onClick={handleClick} className='font-primary-regular flex inline md:block border-2 w-full h-20 md:w-32 md:h-32 p-3 rounded-lg border-slate-300 hover:border-blue-600 focus:border-blue-600 text-left'>
